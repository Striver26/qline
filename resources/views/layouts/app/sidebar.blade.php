...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen text-slate-900 dark:text-slate-100">
        <div class="pointer-events-none fixed inset-x-0 top-0 h-72 bg-[radial-gradient(circle_at_top_left,rgba(20,159,124,0.24),transparent_52%),radial-gradient(circle_at_top_right,rgba(255,116,73,0.16),transparent_38%)]"></div>
        <div class="pointer-events-none fixed bottom-[-140px] right-[-120px] h-80 w-80 rounded-full bg-coral-400/20 blur-3xl"></div>

        <flux:sidebar sticky collapsible="mobile" class="border-e border-white/60 bg-white/78 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/82">
            ...
            <div class="mx-3 mb-3 rounded-[1.5rem] border border-brand-200/70 bg-brand-50/85 p-4 text-sm text-brand-900 shadow-sm dark:border-brand-400/20 dark:bg-brand-500/10 dark:text-brand-100">
                ...
                <p class="mt-2 text-sm leading-relaxed text-brand-900/85 dark:text-brand-50/85">
                    Keep the queue moving, review the slowest handoffs, and make it obvious for customers what happens next.
                </p>
            </div>
