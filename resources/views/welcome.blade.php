    ...
    <header class="relative z-10 px-4 pt-5 sm:px-6 lg:px-8">
        <div
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('lang.switch', 'ms') }}">BM</a>
                <a href="{{ route('login') }}"
                    class="hidden text-sm font-semibold text-slate-600 hover:text-slate-950 sm:inline-flex">
                    Log in
                </a>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <p class="max-w-2xl text-lg text-slate-600">
                        Qline helps customers join from a QR code or WhatsApp, track their turn live, and arrive only
            ...
            <div class="glass-card overflow-hidden !p-0">
                <div class="mesh-accent p-8 text-white">
                    <div class="flex items-center justify-between">
                        <span
                            class="rounded-full border border-white/20 bg-white/10 px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.28em] text-white/90">
                            Live Queue Preview
                        </span>
                    ...
                    <div class="mt-10 rounded-[1.8rem] border border-white/15 bg-white/10 p-6 backdrop-blur-sm">
                        ...
                        <div class="mt-8 grid gap-4 sm:grid-cols-2">
                            ...
                            <div class="rounded-[1.3rem] border border-white/12 bg-black/10 p-4">
                                <p class="text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-white/60">Avg.
                                    Wait</p>
                ...
                <div class="grid gap-4 p-6 sm:grid-cols-3">
                    ...
                    <div class="rounded-[1.4rem] bg-slate-100 p-4">
                        ...
                        <p class="mt-2 text-sm font-semibold text-slate-800">They watch their turn live from the phone.
                        </p>
                    </div>
        ...
        <section class="mx-auto mt-16 max-w-7xl" id="features">
            <div class="page-header">
                <div>
                    ...
                    <h2 class="mt-4 text-4xl font-bold tracking-[-0.06em] text-slate-950">Designed to be obvious for
                        both staff and customers.</h2>
                </div>
                <p class="page-description">
                    The interface is built so customers know where to go next and staff can act without digging through
                    cluttered controls.
                </p>
            </div>
            ...
            <div class="mt-8 grid gap-5 lg:grid-cols-3">
                <article class="feature-card">
                    ...
                    <h3 class="mt-5 text-2xl font-bold tracking-[-0.05em] text-slate-950">A cleaner command center for
                        staff.</h3>
                    <p class="mt-3 text-sm text-slate-600">
                        Open or close the queue, call the next customer, and keep the line moving from one focused
                        dashboard.
                    </p>
                </article>
                <article class="feature-card">
                    <span class="badge-pill">WhatsApp ready</span>
                    <h3 class="mt-5 text-2xl font-bold tracking-[-0.05em] text-slate-950">Customers get updates where
                        they already are.</h3>
                    <p class="mt-3 text-sm text-slate-600">
                ...
                <article class="feature-card">
                    ...
                    <h3 class="mt-5 text-2xl font-bold tracking-[-0.05em] text-slate-950">Feedback and loyalty stay
                        connected.</h3>
                    <p class="mt-3 text-sm text-slate-600">
            ...
            <div class="glass-card">
                <div class="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                    <div>
                        ...
                        <h2 class="mt-4 text-4xl font-bold tracking-[-0.06em] text-slate-950">Three steps from crowded
                            counter to smooth handoff.</h2>
                        <p class="mt-4 text-sm text-slate-600">
                            Qline gives customers confidence while your team stays focused on service instead of
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div class="soft-card">
                            ...
                            <p class="mt-3 text-sm text-slate-600">A QR standee or WhatsApp keyword gets customers into
                                the queue in seconds.</p>
                        </div>
                        <div class="soft-card">
                            <p class="text-sm font-semibold text-brand-700">2. Wait clearly</p>
                            <p class="mt-3 text-sm text-slate-600">They see position, estimated wait time, and live
                                status without asking staff.</p>
                        </div>
                        <div class="soft-card">
                            <p class="text-sm font-semibold text-brand-700">3. Serve smoothly</p>
                            <p class="mt-3 text-sm text-slate-600">Your team calls the next customer with one tap and
                                keeps momentum steady.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="mx-auto mt-16 max-w-7xl" id="pricing">
            <div class="page-header">
                <div>
                    ...
                    <h2 class="mt-4 text-4xl font-bold tracking-[-0.06em] text-slate-950">Pick the pace that matches
                        your business.</h2>
                </div>
                <p class="page-description">
                    Start light for short bursts or go all-in with the monthly plan when queues are a daily part of your
                    operation.
                </p>
            </div>
            ...
            <div class="mt-8 grid gap-6 lg:grid-cols-2">
                <article class="pricing-card">
                    ...
                    <p class="mt-3 text-sm text-slate-600">Perfect for businesses that want flexibility without a long
                        commitment.</p>
                    <p class="mt-8 text-5xl font-bold tracking-[-0.07em] text-slate-950">RM 15<span
                ...
                <article class="pricing-card mesh-accent text-white">
                    ...
                    <p class="mt-3 text-sm text-white/78">For service teams that run queues every day and want all the
                        growth tools included.</p>
        ...
        <section class="mx-auto mt-16 max-w-7xl">
            <div class="glass-card mesh-accent text-center text-white">
                ...
                <p class="mx-auto mt-4 max-w-2xl text-sm text-white/80 sm:text-base">
                    Give your customers a smoother wait and your team a calmer service rhythm with a queue system that
